...
namespace Dev.Api.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        {
            var produtoViewModel = await ObterPorduto(id);
        ...
        {
            var produto = await ObterPorduto(id);
        ...
        private bool UploadArquivo(string arquivo, string imgNome)
        {
            ...
            {
                NotificarError("Forneça uma imagem para esse produto!");
                return false;
            }
        ...
        private async Task<ProdutoViewModel> ObterPorduto(Guid id)
        {
